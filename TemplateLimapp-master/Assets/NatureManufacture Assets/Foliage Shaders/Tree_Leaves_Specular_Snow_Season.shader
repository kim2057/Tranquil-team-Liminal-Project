Shader "NatureManufacture Shaders/Trees/Tree Leaves Specular Snow Season"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 switchResult318 = (((i.ASEVFace>0)?(tex2DNode4):(( tex2DNode4 * float3( -1,-1,-1 ) ))));
			o.Normal = lerp(tex2DNode4,switchResult318,_BackFaceMirrorNormal);
			...
			float4 lerpResult108 = lerp( tex2DNode3 , tex2D( _AlbedoAutumnRGB, uv0_MainTex ) , clampResult255);
			...
			float4 lerpResult51 = lerp( temp_output_97_0 , ( tex2D( _SnowAlbedoRGB, uv0_SnowAlbedoRGB ) - float4( appendResult112 , 0.0 ) ) , lerpResult316);
			...
			float4 tex2DNode98 = tex2D( _AmbientOcclusionGSmoothnessA, uv0_MainTex );
			...
			float clampResult116 = clamp( tex2D( _SnowAmbientOcclusionG, uv0_SnowAlbedoRGB ).g , ( 1.0 - _SnowAmbientOcclusionPower ) , 1.0 );
